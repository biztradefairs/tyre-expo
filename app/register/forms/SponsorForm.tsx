  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="space-y-4 pt-4">
        ...
        <div className="flex items-start gap-3 p-4 bg-white rounded-lg border border-gray-200">
          ...
          <label htmlFor="consent" className="text-sm text-gray-600 leading-relaxed cursor-pointer">
            ...
            with the{" "}
            <a href="/privacy-policy" className="text-[#F08400] hover:text-[#d97000] underline font-medium">
      ...
      <button
        ...
        className={`w-full bg-[#F08400] hover:bg-black text-white font-semibold py-3 px-4 rounded-lg transition-all hover:scale-[1.01] focus:outline-none focus:ring-2 focus:ring-[#F08400] focus:ring-offset-2 ${
