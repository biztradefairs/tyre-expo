      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-[40%_60%] items-center gap-8 sm:gap-10 lg:gap-12">
          ...
          <div className="flex flex-col gap-4 sm:gap-5 lg:gap-6">
            ...
            <h2 className="font-bebas font-bold font-heading font-extrabold text-5xl uppercase tracking-tight text-[28px] sm:text-[34px] md:text-[42px] lg:text-[48px] leading-[1.15] tracking-[1px] uppercase text-black">
              POWERING THE FUTURE OF TYRE INDUSTRY
            </h2>

            <div className="font-sans text-[14px] sm:text-[16px] font-heading font-extrabold text-5xl tracking-tight lg:text-[18px] text-black leading-[1.6] space-y-3 sm:space-y-4">
